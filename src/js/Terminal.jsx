      ...
      if (event.key === "Enter") {
        ...
        if (CommandArea) {
          ...
          if (CommandArea.value === "github") {
            ...
            window.open("https://github.com/ReiynReiyn/terminal-portfolio", '_blank');
          }
          CommandArea.value = "";
        }
      }
        ...
        <ul className='previousCommands' id='console23'>
          {prevusedCommand.map((item, index) => {
            if (item.match(new RegExp(`\\b${"discord"}\\b`, 'g'))) {
              ...
              return <li key={index}>{item}<br></br><br></br><span style={{ color: "#c9c9c9" }}>Opened the source code of this site in a new tab: https://github.com/ReiynReiyn/terminal-portfolio</span><br></br><br></br></li>;
            }
