      ...
      if (event.key === "Enter") {
        ...
        if (CommandArea) {
          ...
          if (CommandArea.value === "github") {
            window.open("https://github.com/ReiynReiyn", '_blank');
          }
          else if (CommandArea.value === "mysite") {
            window.open("https://renisal.me", '_blank');
          }
          else if (CommandArea.value === "source") {
            window.open("https://github.com/ReiynReiyn/mterminal-portfolio", '_blank');
          }
          CommandArea.value = "";
        }
      }
        ...
        <ul className='previousCommands' id='console23'>
          {prevusedCommand.map((item, index) => {
            if (item.match(new RegExp(`\\b${"discord"}\\b`, 'g'))) {
              ...
              return <li key={index}>{item}<br></br><br></br><span style={{ color: "#c9c9c9" }}>Opened my GitHub profile in a new tab: https://github.com/ReiynReiyn</span><br></br><br></br></li>;
            }
              ...
              return <div><li key={index}>{item}</li>
                ...
                <div class="mcq-wrapper"><br></br>
                  <ul id="mcq" class="mcq">
                    <li class="mcq-option" tabindex="0" data-value="regex"><a href="https://ReiynReiyn.github.io/regex-validator" target='_blank' rel="noreferrer">RegEx Validator ↗</a></li>
                    <li class="mcq-option" tabindex="1" data-value="luap"><a href="https://ReiynReiyn.github.io/lua-pattern-tester" target='_blank' rel="noreferrer">Lua Pattern Tester ↗</a></li>
                    <li class="mcq-option" tabindex="2" data-value="apple"><a href="https://ReiynReiyn.github.io/apple-website-clone" target='_blank' rel="noreferrer">Apple Website Clone ↗</a></li>
                    <li class="mcq-option" tabindex="3" data-value="crypto"><a href="https://ReiynReiyn.github.io/cryptodata-retriever" target='_blank' rel="noreferrer">Cryptodata Retriever ↗</a></li>
                    <li class="mcq-option" tabindex="4" data-value="sampserver"><a href="https://github.com/ReiynReiyn/samp-mumbai-rp" target='_blank' rel="noreferrer">SA-MP RP Server Script ↗</a></li>
                    <li class="mcq-option" tabindex="5" data-value="passgen"><a href="https://ReiynReiyn.github.io/password-generator" target='_blank' rel="noreferrer">Password Generator ↗</a></li>
                    <li class="mcq-option" tabindex="6" data-value="uif"><a href="https://github.com/ReiynReiyn/uif-discord-plugin" target='_blank' rel="noreferrer">UIF Discord Rich Presence ↗</a></li>
                    <li class="mcq-option" tabindex="7" data-value="discordbot"><a href="https://github.com/ReiynReiyn/purposebot" target='_blank' rel="noreferrer">Discord Bot ↗</a></li><br></br>
                  </ul>
                </div>
              </div>
            }
              ...
              return <li key={index}>{item}<br></br><br></br><span style={{ color: "#c9c9c9" }}>Opened the source code of this site in a new tab: https://github.com/ReiynReiyn/mterminal-portfolio</span><br></br><br></br></li>;
            }
              ...
              return <div><li key={index}>{item}</li>
                <div className='aboutme'><br></br>
                  Hi, nice to meet you. I'm Reiyn, a 19 years old CS student from India. I'm a casual programmer (doing it just for fun)
                  <br></br><br></br>
